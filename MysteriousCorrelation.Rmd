...
# {data-background="images/coverslide.png"}

---------------------------------------------------------------------

## The Mysterious Correlation {data-background="black"}
### A detective story
...
<tr><td class="noborder" style="width:60%;"></td><td class="noborder" style="width:40%;>
  <h1 class="meme"><b>Causal language for correlation data </b></h1></td></tr>
</table>
...
survey_set %>%
  filter(grepl("Python", HaveWorkedLanguage, fixed=T) ) %>%
  ggplot(aes(x=TabsSpaces, fill=TabsSpaces)) + geom_bar() + 
  scale_fill_manual(values=tableau_color_pal(palette = "tableau10")(3)) +
  theme_minimal(base_size=18) +
  theme(legend.position="none") +
...
Link to github with the talk source code
All data plots in this talk are generated 
